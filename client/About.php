...
<body>
    ...
    <section class="mission-section">
        <div class="mission-container">
            <div class="mission-heading">
                <h2>OUR MISSION</h2>
                <h1>Real Estate for <br>Social Impact</h1>
            </div>
            <div class="mission-description">
                <p>The Lagos Urban Transformation Initiative, LUTI, was born out of a commitment to addressing the housing crisis in Lagos, Nigeria, where rapid urbanization has left millions without access to affordable homes. Our initiative tackles this issue by reimagining real estate as a tool for social good, focusing on sustainable, inclusive, and affordable housing.</p>
                <p>Our mission is to create an inclusive urban future where everyone has a dignified place to call home. We believe that housing should not just be a privilege for the wealthy but a basic right for all, and our approach ensures that profits from premium real estate ventures are used to uplift the underprivileged.</p>
            </div>
        </div>
    </section>
    <section class="values-section">
        ...
        <div class="values-container">
            <div class="value-item">
                ...
                <h3>Empowerment</h3>
                <p>Beyond housing, we provide financial support and advisory services to help residents gain financial independence.</p>
            </div>
            <div class="value-item">
                <div class="value-icon"></div>
                <h3>Inclusivity</h3>
                <p>Our projects cater to all income levels, ensuring that no one is left behind in the quest for urban development.</p>
            </div>
            <div class="value-item">
                <div class="value-icon"></div>
                <h3>Innovation</h3>
                <p>We continuously push the boundaries of real estate by integrating new technologies and design philosophies for more efficient and affordable living spaces.</p>
            </div>
            <div class="value-item">
                <div class="value-icon"></div>
                <h3>Sustainability</h3>
                <p>We prioritize eco-friendly designs and practices that ensure minimal environmental impact and long-term resilience.</p>
            </div>
            <div class="value-item">
                <div class="value-icon"></div>
                <h3>Transparency</h3>
                <p>We maintain openness in our processes, financial dealings, and project implementation to foster trust.</p>
            </div>
        </div>
    </section>
    <section class="leadership-section">
        <div class="leadership-container">
            ...
            <p class="leadership-description">Meet the dedicated team leading our Faith Association with love, faith, and vision.</p>
            <div class="leadership-grid">
                <!-- Leader 1 -->
                <div class="leader-card">
                    <div class="leader-image">
                        <img src="images/Luti-web-portrait_3.jpg" alt="">
                    </div>
                    <h3 class="leader-name">Emmanuel Ejong</h3>
                    <p class="leader-role">CTO</p>
                </div>
                    <!-- Leader 2 -->
                <div class="leader-card">
                    <div class="leader-image">
                        <img src="images/Luti-web-portrait_1.jpg" alt="">
                    </div>
                    <h3 class="leader-name">Olatunde Babatunde</h3>
                    <p class="leader-role">CEO</p>
                </div>
                    <!-- Leader 3 -->
                <div class="leader-card">
                    <div class="leader-image">
                        <img src="images/Luti-web-portrait_2.jpg" alt="">
                    </div>
                    <h3 class="leader-name">Mark Johnson</h3>
                    <p class="leader-role">COO</p>
                </div>
            </div>
        </div>
    </section>
